...
// initializing the fan pin, button pin and the mains pin
int fanPin = d8;
int mainsPin = d5;
int lcdBtn = d7;
int fanBtn = d6;
...
// creating all global alt boolean variable
bool altLcdBtnState = false;
bool altFanBtnState = false;

// creating all boolean global variables
bool isFan = false;
bool isMains = false;
...
void setup() { // put your code here to run once:
  ...
  delay(100);
  // setting which function to run upon request:
